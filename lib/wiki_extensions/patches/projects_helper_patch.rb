...
unless ProjectsHelper.included_modules.include?(WikiExtensions::Patches::ProjectsHelperPatch)
  ProjectsHelper.send(:include, WikiExtensions::Patches::ProjectsHelperPatch)
end
